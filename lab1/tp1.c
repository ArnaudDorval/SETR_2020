...
void maFonctionDeTri(int* base, int num, int (*cmpfunc)(const void*,const void*)){
...
int main(int argc, char *argv[]) {
	...
	qsort(numbers, 					// Notre tableau de nombres a trier
			...
			4, 						// Le nombre d'octets par element;
	...
	maFonctionDeTri(numbers, N_ELEM, fonctionComparatrice);
